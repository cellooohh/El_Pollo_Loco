class Character extends MovableObject {
  ...
  IMAGES_JUMP_UP = ["img/2_character_pepe/3_jump/J-34.png"];

  IMAGES_JUMP_TOP = ["img/2_character_pepe/3_jump/J-35.png"];
  ...
  animate() {
    ...
    setInterval(() => {
      this.pepeDeadHurtJumpWalkAnimation();
    }, 50);
  }
